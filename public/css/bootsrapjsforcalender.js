...
(function(t) {
    ...
    function y(t, e) {
        ...
        return l > a && u > o ?
            (o >= a ?
                ...
                u >= l ?
                ((i = l.clone()), (s = !0)) :
                ((i = u.clone()), (s = !1)), { start: n, end: i, isStart: r, isEnd: s }) :
            void 0;
    }
    ...
    function b(t, e) {
        var n, i, r;
        for (
            n = 0; ze.length > n && ((i = ze[n]), (r = D(i, t, e)), !(r >= 1 && V(r))); n++
        );
        return i;
    }
    ...
    function se(n) {
        ...
        return (
            ...
            (o = Boolean(o)), { eventProps: i, startTime: r, duration: s, stick: o }
        );
    }
    ...
    function ye(n) {
        ...
        function R(e, n) {
            ...
            return (
                ...
                (r = n.allDay ? S(n.start, e._start) : E(n.start, e._start)), !i &&
                n.end &&
    ...
    var $e = Xe.extend({
        ...
        updateCells: function() {
            ...
            if (
                ...
                for (
                    e = t[0].day(), i = 1; t.length > i && t[i].day() != e; i++
                );
        ...
        renderDrag: function(t, e) {
            ...
            return (
                ...
                (this.renderRangeHelper(t, e),
                    ...
                    void 0 !== n && this.helperEls.css("opacity", n), !0) :
                void 0
            );
        },
        destroyDrag: function() {
    ...
    $e.mixin({
            ...
            fgSegHtml: function(t, e) {
                var n,
                    ...
                    u = "";
                return (
                    l.unshift("fc-day-grid-event"), !r.allDay &&
                    t.isStart &&
                    (u =
                        '<span class="fc-time">' +
        ...
        $e.mixin({
            ...
            limitRow: function(e, n) {
                ...
                if (n && S.segLevels.length > n) {
                    for (
                        ...
                        for (
                            u = s[a], i(u.leftCol), h = [], c = 0; u.rightCol >= D;
            ...
            renderSegPopoverContent: function(e, n) {
                ...
                for (
                    n = this.renderFgSegEls(n, !0), this.popoverSegs = n, i = 0; n.length > i; i++
                )
    ...
    var Ue = Xe.extend({
        ...
        renderDrag: function(t, e) {
            ...
            return e ?
                (this.renderRangeHelper(t, e),
                    (n = this.view.opt("dragOpacity")),
                    void 0 !== n && this.helperEl.css("opacity", n), !0) :
                (this.renderHighlight(
                        this.view.calendar.ensureVisibleEventRange(t)
                    ),
                    void 0);
        ...
        renderHelper: function(e, n) {
            ...
            for (
                l = this.renderFgSegEls(l), i = this.renderSegTable(l), r = 0; l.length > r; r++
            )
                (s = l[r]),
                n &&
                n.col === s.col &&
    ...
    Ue.mixin({
        ...
        renderSegTable: function(e) {
            var n,
                ...
                u = a.find("tr");
            for (
                n = this.groupSegCols(e), this.computeSegVerticals(e), s = 0; n.length > s; s++
            ) {
                for (
                    o = n[s],
                    ae(o),
    ...
    var qe = (De.View = K.extend({
        ...
        trigger: function(t, e) {
            ...
            return n.trigger.apply(
                n, [t, e || this].concat(
                    Array.prototype.slice.call(arguments, 2), [this]
                )
            );
        },
        setDate: function(t) {
        ...
        computePrevDate: function(t) {
            return this.massageCurrentDate(
                ...
                .subtract(this.intervalDuration), -1
            );
        },
        ...
        skipHiddenDays: function(t, e, n) {
            var i = t.clone();
            for (
                e = e || 1; this.isHiddenDayHash[(i.day() + (n ? e : 0) + 7) % 7];
        ...
        computeDayRange: function(t) {
            ...
            return (
                ...
                (!i || n >= r) && (r = n.clone().add(1, "days")), { start: n, end: r }
            );
        },
        ...
        Je = (Ce.basic = qe.extend({
            ...
            setHeight: function(t, e) {
                ...
                g(this.scrollerEl),
                    ...
                    i && "number" != typeof i && this.dayGrid.limitRows(i), !e &&
                    f(this.scrollerEl, n) &&
