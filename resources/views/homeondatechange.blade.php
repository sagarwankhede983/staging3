                    ...
                    <div><label>Date:</label><input style="margin-left: 1%;width: 120px" name="filterdate" id="demodate"><button style="margin-left: 1%" type="submit" class="btn btn-primary" id="btn_submit">Submit</button></div>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">
                                        <table>
                                                <tr>
                                                    <td style="text-align: left;width: 10%">Menu</td>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="fromDashboardOnDateMenu/{{base64_encode($todayDate)}}">View Details</a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">
                                        <table>
                                                <tr>
                                                    <td style="text-align: left;width: 10%">Breakfast</td>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        ...
                                        <a class="small text-white stretched-link" href="fromDashboardOnDateBreakfast/{{base64_encode($todayDate)}}">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                   <div class="card-body">
                                            <table>
                                        <tr>
                                            <td style="text-align: left;width: 10%">Lunch</td>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="fromDashboardOnDateLunch/{{base64_encode($todayDate)}}">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                ...
                                <table>
                                        <tr>
                                            <td style="text-align: left;width: 10%">Dinner</td>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="fromDashboardOnDateDinner/{{base64_encode($todayDate)}}">View Details</a>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-custom{{$j}} text-white mb-4">
                               <div class="card-body">
                                    <table>
                                        <tr>
                                            <td style="text-align: left;width: 10%">{{$event_type}}</td>
                                            <td style="text-align: right; width: 10%"><span style="font-size:15px;font-color:black;font-weight: 1000">{{$item_count}}</span></td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="fromDashboardOnDateOtherEvent/{{base64_encode($event_type)}}/{{base64_encode($todayDate)}}">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                 ...
                 <div class="col-xl-3 col-md-6">
                         ...
                         <div class="col-xl-3 col-md-6">
                            <div class="card bg-custom40 text-white mb-4">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="fromDashboardOnDateEvents/{{base64_encode($todayDate)}}">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="row">
                            <div class="col-xl-6">
                                <div class="card mb-4" style="height: auto !important">
                                    <div class="card-header"><i class="fas fa-chart-area mr-1"></i> Item Count</div>
                                    <div class="card-body"><canvas id="myChartMenus" width="500" height="400"></canvas></div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="card mb-4" style="height: auto !important">
                                    <div class="card-header"><i class="fas fa-chart-bar mr-1"></i> Event Count</div>
