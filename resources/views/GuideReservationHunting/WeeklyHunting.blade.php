       ...
       @include('partials.navbarheader')
                                    ...
                                    @if (\Session::has('success'))
                                       ...
                                       <div class="panel panel-default">
                                             <div class="panel-heading" style="background-color: #20a8d8">
                                              ...
                                              <div>
                                                 <form action="/fromDashboardWeeklyMenuBtnPress/fromDate/todate" method="get" style="margin: 2%">
                                                    <table width="100%">
                                                        <tr>
        ...
        <script>
            ...
            function fun2(){
                 ...
                 //     $.ajax({
                 //     type: 'get',
                 //     url: 'http://rsdashboard.king-ranch.com/fromDashboardWeeklyMenuBtnPress',
                 //     data: {fromDate:firstDayFormated},
