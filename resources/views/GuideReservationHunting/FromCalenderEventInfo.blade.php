                                      ...
                                      <div class="table-responsive">
                                          <table class="table table-bordered table-striped table-hover datatable">
                                                  <thead>
                                                                ...
                                                                <?php
                                                                                          $i=0;
                                                                                          foreach ($HuntingEventInfo_ar as $id => $eventcount) {
                                                                                            $event_id=$HuntingEventInfo_ar[$i]['event_id'];
                                                                                              $item_id=$HuntingEventInfo_ar[$i]['item_id'];
                                                                                              $item_name=$HuntingEventInfo_ar[$i]['item_name'];
                                                                                              $room=$HuntingEventInfo_ar[$i]['room'];
                                                                                              $name=$HuntingEventInfo_ar[$i]['name'];?>
