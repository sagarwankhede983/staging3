                ...
                <div class="container-fluid">
                    ...
                    <div style="margin-bottom:2%; margin-top:2%">
                        ...
                        <div style="margin-left:60%;">
                            <form method="post" action="/ondateHuntingFromPage">
                                {{ csrf_field() }}
                                <div class="container">
                                    <?php if($date==""){
                                    ?>
                                    <label>Date:</label><input style="margin-left: 1%" name="filterdate"
                                        id="demodate"><button style="margin-left: 1%" type="submit"
                                    ...
                                    <label>Date:</label><input style="margin-left: 1%" name="filterdate" id="demodate"
                                        value="<?php echo $date; ?>"><button style="margin-left: 1%" type="submit"
                                        class="btn btn-primary" id="btn_submit">Submit</button>
                                    <?php
                                    }
                                    ?>
                    ...
                    <button class="tablink" onclick="openPage('AssignedGuide', this, '#48bfbf')"
                        id="defaultOpen">ASSIGNED GUIDE</button>
                    <button class="tablink" onclick="openPage('UnassignedGuide', this, '#4a4c68')">AVAILABLE
                        GUIDE</button>
                                        ...
                                        <tbody>
                                            <?php
                                                        ...
                                                        foreach ($totalAsignedGuideInfo_ar as $id => $eventcount) {
                                                            ...
                                                            $name=$totalAsignedGuideInfo_ar[$i]['name']; $room=$totalAsignedGuideInfo_ar[$i]['room'];
