                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover datatable">
                                    ...
                                    <tbody>
                                        <?php
                                              $i=0;
                                                    foreach ($assignedGuideInfo_ar as $id => $eventcount) {
                                                    $item_id=$assignedGuideInfo_ar[$i]['item_id'];
                                                    $item_name=$assignedGuideInfo_ar[$i]['item_name'];
                                                    $start_datetime=$assignedGuideInfo_ar[$i]['start_datetime'];
                                                    $room=$assignedGuideInfo_ar[$i]['room'];
                                                    $name=$assignedGuideInfo_ar[$i]['name'];?>
