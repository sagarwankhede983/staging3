              ...
              ?>
                  ...
                  <div class="table-responsive">
                      <table class="table table-bordered table-striped table-hover datatable">
                          ...
                          <?php
                          $i=0;
                          foreach ($event_info_ar as $id => $eventcount) {
                              $itemcount=$event_info_ar[$i]['itemcount'];
                              $item_id=$event_info_ar[$i]['item_id'];
                              $item_name=$event_info_ar[$i]['item_name'];
                              $item_desc_db=$event_info_ar[$i]['item_desc'];
                              if(empty($item_desc_db)){
                    $item_desc_db="NA";
                  }
                              $start_datetime=$event_info_ar[$i]['start_datetime'];?>
