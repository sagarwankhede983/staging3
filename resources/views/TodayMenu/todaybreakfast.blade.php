                                ...
                                <div class="card" style="height: auto !important; margin-top: 1%">
                                  ...
                                  <div class="table-responsive">
                                      <table class="table table-bordered table-striped table-hover datatable">
                                          ...
                                          <?php
                                          $i=0;
                                          foreach ($breakfast_ar as $id => $eventcount) {
                                              $itemcount=$breakfast_ar[$i]['itemcount'];
                                              $item_id=$breakfast_ar[$i]['item_id'];
                                              $item_name=$breakfast_ar[$i]['item_name'];
                                              $item_desc_db=$breakfast_ar[$i]['item_desc'];
                                              if(empty($item_desc_db)){
                                    $item_desc_db="NA";
                                  }
                                              $start_datetime=$breakfast_ar[$i]['start_datetime'];?>
