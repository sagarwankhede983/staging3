                                ...
                                <table class="table table-bordered table-striped table-hover datatable">
                                    ...
                                    <tbody>
                                        <?php
                                              ...
                                              $i=0;
                                              foreach($lunch_ar as $id => $eventcount)  {
                                              $itemcount=$lunch_ar[$i]['itemcount'];
                                              $item_id=$lunch_ar[$i]['item_id'];
                                              $item_name=$lunch_ar[$i]['item_name'];
                                              $item_desc_db=$lunch_ar[$i]['item_desc'];
                                              if(empty($item_desc_db)){
                                        $item_desc_db="NA";
                                      }
                                              $start_datetime=$lunch_ar[$i]['start_datetime'];
                                              ?>
                                        <tr style="align-content: center">
                                            ...
                                            <td class="text-left"><a
                                                    href="/viewDetailFromDashboard\{{base64_encode($item_id)}}\{{base64_encode($item_name)}}\{{base64_encode($item_desc_db)}}\{{base64_encode($start_datetime)}}">View
                                                    Detail</a></td>
                                        </tr>
                                        <?php
                                                  $i++;
