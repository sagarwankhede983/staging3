...
return [
    ...
    'manageMenu'                       => [
        'title'          => 'Manage Menu',
        'title_singular' => 'Manage Menu',
        'fields'         => [],
    ],
    'todayMenu'                       => [
        'title'          => 'Today Menus',
        'title_singular' => 'Today Menu',
        'fields'         => [],
    ],
    'onDateMenu'                       => [
        'title'          => 'Date Wise Menus',
        'title_singular' => 'On Date Menu',
        'fields'         => [],
    ],
    'betweenDateMenu'                       => [
        'title'          => 'Weekly Menus',
        'title_singular' => 'Weekly Menu',
        'fields'         => [],
    ],
    'manageCustomer'                       => [
    ...
    'todayCustomer'                       => [
        ...
        'title_singular' => 'Today Customer',
        'fields'         => [],
    ],
    'dateWiseCustomer'                       => [
        'title'          => 'Weekly Customer',
        'title_singular' => 'Weekly Customer',
        'fields'         => [],
    ],
    'breakfast'=>'Breakfast',
    'lunch'=>'Lunch',
